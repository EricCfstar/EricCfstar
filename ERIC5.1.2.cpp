...
int cincode()
{
	if(CinCode_TOF==0)
	{
		...
		if(CoutCode==100)
		{
			...
			cout<<" 一小段对话：\n";
			_sleep(200);
			cout<<" 灯火：偷偷告诉你，原罪喜欢萝莉:)\n";
			_sleep(100);
			cout<<" 原罪：这辈子不想萝莉是不可能的咧( bushi)\n你不是也喜欢？\n";
			_sleep(300);
			cout<<" 灯火：好像是的[doge]\n";
			_sleep(3000);
			cout<<" 原罪：我要追妹子！\n";
		...
		if(CoutCode==520)
		{
			...
			system("title 好玩滴功能");
			{
				...
				cout<<" 4 创建聊天室（生草聊天系统）\n";
				cout<<" 5 返回主页\n";
				cout<<" (基于生草聊天系统的ERIC聊天室：房间名称Grass_ERIC，房间密匙ilovegrassmsg)\n";
				cout<<" >";
				cin>>y;
				if(y==1)
				{
					system("cls");
					cout<<"程序还在测试中，你可以提前查看哦！\n";
					system("pause");
					system("cls");
					cout<<"页面即将跳转到浏览器_生草博客，请做好准备\n";
					system("timeout /t 3");
					system("start https://cfstar.cn");
				}
				if(y==2)
				{
					system("cls");
					...
					system("pause");
					system("cls");
					cout<<"页面即将跳转到浏览器_生草云盘，请做好准备\n";
					system("timeout /t 3");
					system("start https://pan.cfstar.cn");
				}
				if(y==3)
				{
					system("cls");
					...
					system("pause");
					system("cls");
					cout<<"页面即将跳转到浏览器_生草聊天系统，请做好准备\n";
					system("timeout /t 3");
					system("start https://msg.cfstar.cn");
				}
				if(y==4)
				{
					system("cls");
					...
					cout<<"页面即将跳转到浏览器_生草聊天系统，请做好准备\n";
					system("timeout /t 3");
					system("start https://msg.cfstar.cn/create.html");
				}
				if(y==5)
				{
		...
		if(CoutCode==102)
		{
			...
			system("title 隐藏指令");
			cout<<" ERIC\n";
			cout<<" 灯火计算机各方面掌握的知识量占此方面总体知识统计图:\n";
			cout<<" Cmd:\n";
			cout<<" ————————————————————————————————————————\n";
			cout<<" 批处理（Bat）:\n";
			cout<<" —————————————————————————————————————\n";
		...
		if(CoutCode==1000)
		{
			...
			cout<<" 3.Eric/EricCfstar :关于EricCfstar的编程统计图\n";
